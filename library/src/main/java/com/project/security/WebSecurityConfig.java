...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter{
	...
	protected void configure(HttpSecurity http) throws Exception {
	       ...
	       http.cors().and().csrf().disable().authorizeRequests()
           					...
           					.antMatchers(HttpMethod.POST, "/borrow/*").hasRole(SecurityUserRole.USER.name())
           					.antMatchers(HttpMethod.GET, "/borrow/*").hasRole(SecurityUserRole.USER.name())
           					.antMatchers(HttpMethod.DELETE, "/borrow/*").hasRole(SecurityUserRole.USER.name())
